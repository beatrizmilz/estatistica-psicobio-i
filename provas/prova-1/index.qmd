...
:::callout
Conversar mais:
Precisamos testar o mauchly - Esfericidade. Usar o total?
:::
...
-   O que 112% de proporção significa? É possível ter proporção maior que 100%?
...
::: callout
Não pode ser wilcoxon, pq esse é para medidas pareadas!
:::
...
-   [x] Se o intervalo de confiança para a diferença entre os momentos incluir o valor zero, podemos concluir que não há diferença significativa entre os momentos. **Dezena acha que é essa! ela disse que o professor falou sobre isso na aula, rever**
...
:::callout
Ver referência: <https://midia.atp.usp.br/plc/plc0503/impressos/plc0503_04.pdf>
:::
...
- razão de prevalencia p/ transversal

- odds ratio p/ caso-controle

- risco relativo p/ coorte
